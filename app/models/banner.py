...
class Banner(Base):
    ...
    image_uz: Mapped[str] = mapped_column(Text, nullable=False, default="")
    image_ru: Mapped[str] = mapped_column(Text, nullable=False, default="")
    ...
    slot: Mapped[str] = mapped_column(String(20), nullable=False, default="home")
